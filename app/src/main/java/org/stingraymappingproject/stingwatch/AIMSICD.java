...
import org.stingraymappingproject.stingwatch.activities.BaseActivity;
import org.stingraymappingproject.stingwatch.activities.DebugLogs;
import org.stingraymappingproject.stingwatch.activities.MapViewerOsmDroid;
import org.stingraymappingproject.stingwatch.activities.PrefActivity;
import org.stingraymappingproject.stingwatch.adapters.AIMSICDDbAdapter;
import org.stingraymappingproject.stingwatch.constants.DrawerMenu;
import org.stingraymappingproject.stingwatch.drawer.DrawerMenuActivityConfiguration;
import org.stingraymappingproject.stingwatch.drawer.NavDrawerItem;
import org.stingraymappingproject.stingwatch.fragments.AboutFragment;
import org.stingraymappingproject.stingwatch.fragments.AtCommandFragment;
import org.stingraymappingproject.stingwatch.fragments.DetailsContainerFragment;
...
import org.stingraymappingproject.stingwatch.utils.Icon;
import org.stingraymappingproject.stingwatch.utils.LocationServices;
import org.stingraymappingproject.stingwatch.utils.RequestTask;
    ...
    void selectItem(int position) {
        ...
        switch (selectedItem.getId()) {
            ...
            case DrawerMenu.ID.APPLICATION.UPLOAD_LOCAL_BTS_DATA:
                ...
                new RequestTask(mContext, RequestTask.DBE_UPLOAD_REQUEST).execute(""); // no string needed for csv based upload
                break;
        }
